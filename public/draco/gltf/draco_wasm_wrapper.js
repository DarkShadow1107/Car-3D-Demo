...
var DracoDecoderModule = (function () {
	...
	return (
		...
		function (e) {
			...
			function i(t) {
				(ut = t),
					(w.HEAP8 = _t = new Int8Array(t)),
					(w.HEAP16 = new Int16Array(t)),
					(w.HEAP32 = pt = new Int32Array(t)),
					(w.HEAPU8 = it = new Uint8Array(t)),
					(w.HEAPU16 = new Uint16Array(t)),
					(w.HEAPU32 = new Uint32Array(t)),
					(w.HEAPF32 = new Float32Array(t)),
					(w.HEAPF64 = new Float64Array(t));
			}
			function p(t) {
				for (; 0 < t.length; ) {
					var e = t.shift();
			...
			function a(t) {
				throw (
					...
					tt(t),
					(nt = !0),
					new WebAssembly.RuntimeError("abort(" + t + "). Build with -s ASSERTIONS=1 for more info."))
				);
			}
			function u(t) {
				...
				if ("string" == typeof t) {
					for (var e = 0, r = 0; r < t.length; ++r) {
						...
						55296 <= n && 57343 >= n && (n = (65536 + ((1023 & n) << 10)) | (1023 & t.charCodeAt(++r))),
							127 >= n ? ++e : (e = 2047 >= n ? e + 2 : 65535 >= n ? e + 3 : e + 4);
					}
					if (((r = 0), 0 < (n = (e = Array(e + 1)).length))) {
						...
						for (var o = 0; o < t.length; ++o) {
							...
							if (
								(55296 <= _ && 57343 >= _ && (_ = (65536 + ((1023 & _) << 10)) | (1023 & t.charCodeAt(++o))),
								127 >= _)
							) {
								if (r >= n) break;
								e[r++] = _;
			...
			if (k) {
				...
				x
					? ("undefined" != typeof read &&
					  ...
					  (Z = function (t) {
							return "function" == typeof readbuffer
								...
								: (r("object" == typeof (t = read(t, "binary"))), t);
					  }),
					...
					: (Q || $) &&
					  ($ ? (Y = self.location.href) : document.currentScript && (Y = document.currentScript.src),
					  t && (Y = t),
			...
			var X,
				J = w.print || console.log.bind(console),
				tt = w.printErr || console.warn.bind(console);
			for (V in B) B.hasOwnProperty(V) && (w[V] = B[V]);
			(B = null),
				w.thisProgram && (W = w.thisProgram),
				w.wasmBinary && (X = w.wasmBinary),
				"object" != typeof WebAssembly && tt("no native wasm support detected");
			var et,
				rt = new WebAssembly.Table({ initial: 293, maximum: 293, element: "anyfunc" }),
				nt = !1,
			...
			var _t,
				it,
				pt,
				at = w.TOTAL_MEMORY || 16777216;
			if ((et = w.wasmMemory ? w.wasmMemory : new WebAssembly.Memory({ initial: at / 65536 }))) var ut = et.buffer;
			(at = ut.byteLength), i(ut), (pt[3416] = 5256704);
			var ct = [],
				st = [],
				lt = [],
				yt = [],
			...
			var At,
				ht = "draco_decoder.wasm";
			u(ht) || ((At = ht), (ht = w.locateFile ? w.locateFile(At, Y) : Y + At)),
				st.push({
					func: function () {
						Gt();
					},
			...
			var Tt = {},
				...
				It = {
					...
					emscripten_resize_heap: function (t) {
						...
						for (var e = Math.max(_t.length, 16777216); e < t; )
							e = 536870912 >= e ? _(2 * e, 65536) : Math.min(_((3 * e + 2147483648) / 4, 65536), 2147418112);
						t: {
							try {
					...
					fd_write: function (t, e, r, n) {
						try {
							for (var o = 0, _ = 0; _ < r; _++) {
								for (var i = pt[(e + 8 * _) >> 2], p = pt[(e + (8 * _ + 4)) >> 2], u = 0; u < p; u++)
									Dt.printChar(t, it[i + u]);
								o += p;
							}
							return (pt[n >> 2] = o), 0;
						} catch (t) {
				...
				vt = (function () {
					function t(t, e) {
						(w.asm = t.exports),
							mt--,
							w.monitorRunDependencies && w.monitorRunDependencies(mt),
							0 == mt && (null !== dt && (clearInterval(dt), (dt = null)), bt && ((t = bt), (bt = null), t()));
					}
					function e(e) {
						t(e.instance);
					}
					function r(t) {
						return (
							X || (!Q && !$) || "function" != typeof fetch
								? new Promise(function (t, e) {
										t(c());
								  })
								: fetch(ht, { credentials: "same-origin" })
										.then(function (t) {
					...
					var n = { env: It, wasi_unstable: It };
					if ((mt++, w.monitorRunDependencies && w.monitorRunDependencies(mt), w.instantiateWasm))
						try {
					...
					return (
						(function () {
							if (X || "function" != typeof WebAssembly.instantiateStreaming || u(ht) || "function" != typeof fetch)
								return r(e);
							fetch(ht, { credentials: "same-origin" }).then(function (t) {
								return WebAssembly.instantiateStreaming(t, n).then(e, function (t) {
									tt("wasm streaming compile failed: " + t),
										tt("falling back to ArrayBuffer instantiation"),
										r(e);
								});
							});
						})(),
			...
			var Gt = (w.___wasm_call_ctors = function () {
				...
				$t = (w._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function () {
					return w.asm.emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0.apply(
						null,
						arguments
					);
				}),
				...
				ue = (w._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function () {
					return w.asm.emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0.apply(
						null,
						arguments
					);
				}),
				...
				Kr = (w._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM = function () {
					return w.asm.emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM.apply(
						null,
						arguments
					);
				}),
				Zr = (w._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM = function () {
					return w.asm.emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM.apply(
						null,
						arguments
					);
				}),
			...
			var an = {
				...
				alloc: function (t, e) {
					return (
						r(an.buffer),
						(t = (7 + (t = t.length * e.BYTES_PER_ELEMENT)) & -8),
						an.pos + t >= an.size
							? (r(0 < t), (an.needed += t), (e = w._malloc(t)), an.temps.push(e))
							: ((e = an.buffer + an.pos), (an.pos += t)),
						e
					);
				},
				copy: function (t, e, r) {
			...
			return (
				...
				(b.__cache__ = {}),
				(w.Status = b),
				(b.prototype.code = b.prototype.code =
					function () {
						return jt(this.ptr);
					}),
				(b.prototype.ok = b.prototype.ok =
					function () {
						return !!Et(this.ptr);
					}),
				(b.prototype.error_msg = b.prototype.error_msg =
					function () {
				...
				(h.__cache__ = {}),
				(w.PointCloud = h),
				(h.prototype.num_attributes = h.prototype.num_attributes =
					function () {
						return Ut(this.ptr);
					}),
				(h.prototype.num_points = h.prototype.num_points =
					function () {
						return Ft(this.ptr);
					}),
				...
				(T.__cache__ = {}),
				(w.DracoUInt8Array = T),
				(T.prototype.GetValue = T.prototype.GetValue =
					function (t) {
						var e = this.ptr;
				...
				(I.__cache__ = {}),
				(w.AttributeOctahedronTransform = I),
				...
				(v.prototype.GetAttributeTransformData = v.prototype.GetAttributeTransformData =
					function () {
						return m(Zt(this.ptr), G);
					}),
				(v.prototype.attribute_type = v.prototype.attribute_type =
					function () {
						return Xt(this.ptr);
					}),
				(v.prototype.data_type = v.prototype.data_type =
					function () {
						return Jt(this.ptr);
					}),
				(v.prototype.num_components = v.prototype.num_components =
					function () {
						return te(this.ptr);
					}),
				(v.prototype.normalized = v.prototype.normalized =
					function () {
						return !!ee(this.ptr);
					}),
				(v.prototype.byte_stride = v.prototype.byte_stride =
					function () {
						return re(this.ptr);
					}),
				(v.prototype.byte_offset = v.prototype.byte_offset =
					function () {
						return ne(this.ptr);
					}),
				(v.prototype.unique_id = v.prototype.unique_id =
					function () {
						return oe(this.ptr);
					}),
				...
				(G.__cache__ = {}),
				(w.AttributeTransformData = G),
				(G.prototype.transform_type = G.prototype.transform_type =
					function () {
						return pe(this.ptr);
					}),
				...
				(j.__cache__ = {}),
				(w.AttributeQuantizationTransform = j),
				...
				(j.prototype.min_value = j.prototype.min_value =
					function (t) {
						var e = this.ptr;
						return t && "object" == typeof t && (t = t.ptr), le(e, t);
					}),
				(j.prototype.range = j.prototype.range =
					function () {
						return ye(this.ptr);
					}),
				...
				(O.prototype.GetIntEntryArray = O.prototype.GetIntEntryArray =
					function (t, e, r) {
						var n = this.ptr;
						an.prepare(),
							t && "object" == typeof t && (t = t.ptr),
				...
				(M.__cache__ = {}),
				(w.Decoder = M),
				(M.prototype.GetEncodedGeometryType = M.prototype.GetEncodedGeometryType =
					function (t) {
						var e = this.ptr;
						return t && "object" == typeof t && (t = t.ptr), ke(e, t);
					}),
				(M.prototype.DecodeBufferToPointCloud = M.prototype.DecodeBufferToPointCloud =
					function (t, e) {
						var r = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), m(xe(r, t, e), b)
						);
					}),
				(M.prototype.DecodeBufferToMesh = M.prototype.DecodeBufferToMesh =
					function (t, e) {
						var r = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), m(Qe(r, t, e), b)
						);
					}),
				(M.prototype.GetAttributeId = M.prototype.GetAttributeId =
					function (t, e) {
						var r = this.ptr;
				...
				(M.prototype.GetAttribute = M.prototype.GetAttribute =
					function (t, e) {
						var r = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), m(qe(r, t, e), v)
						);
					}),
				(M.prototype.GetAttributeByUniqueId = M.prototype.GetAttributeByUniqueId =
					function (t, e) {
						var r = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), m(Ye(r, t, e), v)
						);
					}),
				(M.prototype.GetMetadata = M.prototype.GetMetadata =
					function (t) {
						var e = this.ptr;
				...
				(M.prototype.GetAttributeMetadata = M.prototype.GetAttributeMetadata =
					function (t, e) {
						var r = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr), e && "object" == typeof e && (e = e.ptr), m(Ze(r, t, e), C)
						);
					}),
				(M.prototype.GetFaceFromMesh = M.prototype.GetFaceFromMesh =
					function (t, e, r) {
						var n = this.ptr;
						return (
							t && "object" == typeof t && (t = t.ptr),
				...
				(M.prototype.GetTriangleStripsFromMesh = M.prototype.GetTriangleStripsFromMesh =
					function (t, e) {
						var r = this.ptr;
				...
				(N.__cache__ = {}),
				(w.Mesh = N),
				(N.prototype.num_faces = N.prototype.num_faces =
					function () {
						return mr(this.ptr);
					}),
				(N.prototype.num_attributes = N.prototype.num_attributes =
					function () {
						return dr(this.ptr);
					}),
				(N.prototype.num_points = N.prototype.num_points =
					function () {
						return br(this.ptr);
					}),
				...
				(function () {
					function t() {
						(w.OK = Er()),
							(w.DRACO_ERROR = Or()),
							(w.IO_ERROR = Rr()),
							(w.INVALID_PARAMETER = Pr()),
							(w.UNSUPPORTED_VERSION = gr()),
							(w.UNKNOWN_VERSION = Sr()),
							(w.DT_INVALID = Mr()),
							(w.DT_INT8 = Nr()),
							(w.DT_UINT8 = Ur()),
							(w.DT_INT16 = Fr()),
							...
							(w.DT_BOOL = xr()),
							(w.DT_TYPES_COUNT = Qr()),
							(w.INVALID_GEOMETRY_TYPE = $r()),
							(w.POINT_CLOUD = Wr()),
							(w.TRIANGULAR_MESH = Hr()),
							(w.ATTRIBUTE_INVALID_TRANSFORM = qr()),
							(w.ATTRIBUTE_NO_TRANSFORM = Yr()),
							(w.ATTRIBUTE_QUANTIZATION_TRANSFORM = Kr()),
							(w.ATTRIBUTE_OCTAHEDRON_TRANSFORM = Zr()),
							(w.INVALID = Xr()),
							(w.POSITION = Jr()),
							(w.NORMAL = tn()),
							(w.COLOR = en()),
				...
				"function" == typeof w.onModuleParsed && w.onModuleParsed(),
				e
			);
		}
	);
